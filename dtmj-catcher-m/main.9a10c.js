(function () {
    ...
    function boot () {
        ...
        if (!false) {
            var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.aed09.js';
            if (jsList) {
    ...
    if (false) {
        require(window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.60669.js');
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.60669.js';
